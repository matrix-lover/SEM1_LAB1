...
int main() {
    float a {21}; // для миллиметров(дробное число)
    int b {54}; // для метров и сантиметров
    ...
    float millimetr = (a * 25.4) - metr * 1000 - smetr * 10; // умножение на 25.4, и вычетание метров и сантиметров, переведенных в миллиметры
